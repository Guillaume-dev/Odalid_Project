            ...
            <div class="col-md-6">
                <div class="btn-group" id="status" data-toggle="buttons">
                    <label class="btn btn-default btn-on-1 btn-sm active waves-effect waves-light" id="open">
                        <input type="radio" value="1" name="multifeatured_module[module_id][status]">Oui</label>
                    <label class="btn btn-default btn-off-1 btn-sm   waves-effect waves-light" id="close">
                        <input type="radio" value="0" name="multifeatured_module[module_id][status]" checked="checked">Non</label>
                </div>
            </div>
        </div>
